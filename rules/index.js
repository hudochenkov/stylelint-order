...
import { rule as customPropertiesAlphabeticalOrder } from './custom-properties-alphabetical-order/index.js';

export const rules = {
	order,
	'properties-order': propertiesOrder,
	'properties-alphabetical-order': propertiesAlphabeticalOrder,
	'custom-properties-alphabetical-order': customPropertiesAlphabeticalOrder,
};
